...
class GfxRomWriter(object):
    ...
    def __init__(self, lo, hi, is_scr: bool):
        ...
        self.is_scr = is_scr
        if is_scr:
            self.planeoffsets_hi = self.scr_planeoffsets_hi
            self.xoffsets_hi = self.scr_xoffsets_hi
        else:
            self.planeoffsets_hi = self.obj_planeoffsets_hi
            self.xoffsets_hi = self.obj_xoffsets_hi
